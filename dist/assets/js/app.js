...
/*
  Switch actions
*/
(0, _jquery2.default)('.unmask').on('click', function () {

  if ((0, _jquery2.default)(this).prev('input').attr('type') == 'password') changeType((0, _jquery2.default)(this).prev('input'), 'text');else changeType((0, _jquery2.default)(this).prev('input'), 'password');
...
function changeType(x, type) {
  ...
  try {
    ...
    var html = (0, _jquery2.default)("<div>").append(x.clone()).html();
    var regex = /type=(\")?([^\"\s]+)(\")?/; //matches type=text or type="text"
    //If no match, we add the type attribute to the end; otherwise, we replace
    var tmp = (0, _jquery2.default)(html.match(regex) == null ? html.replace(">", ' type="' + type + '">') : html.replace(regex, 'type="' + type + '"'));
